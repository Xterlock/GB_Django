...
from .models import Client, Product, OrderProducts
...
def clients_list(request):
    ...
    return render(request, 'app/clients_list.html', context=context)
...
def client_orders(request, client_id):
    ...
    return render(request, 'app/client_orders.html', context)
...
def client_prods(request, client_id, days_history):
    ...
    return render(request, 'app/client_products.html', context)
...
def product_create(request):
    ...
    return render(request, 'app/product_create.html', {'title': 'Новый товар', 'form': form})
...
def product_info(request, prod_id: int):
    ...
    return render(request, 'app/product_info.html', {'prod': prod})
